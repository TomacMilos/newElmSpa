module Pages.TeacherPages.UpisOcene.Id_ exposing (Model, Msg, page)

import Gen.Params.TeacherPages.UpisOcene.Id_ exposing (Params)
import Page
import Request
import Shared
        ...
        Saved exam ->
            ...
            , case exam of
                Api.Data.Success newStudent ->
                    ...
                    (Route.TeacherPages__Course__Id_ { id = model.id })
                _ ->
                    Cmd.none
            )
-- SUBSCRIPTIONS
